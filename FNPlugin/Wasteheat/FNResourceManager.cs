    ...
    public class FNResourceManager : ORSResourceManager 
    {
        ...
        protected override void pluginSpecificImpl() 
        {
            ...
            {   
                ...
                //this hack makes radiation a little more realistic in my opinion
                //did you know that things radiate with the fourth power of their temperature? wow neat stuff
                //double passive_dissip = passive_temp_p4 * GameConstants.stefan_const * vessel_mass * 2.0;
                double passive_dissip = passive_temp_p4 * GameConstants.stefan_const * vessel_mass * 100.0;
